  ...
  <div class="app-container">
    ...
    <el-dialog :close-on-click-modal="false" :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible" width="40%">
      <el-form ref="dataForm" :model="temp" size="medium" label-position="left" label-width="100px" style="padding: 0 80px 0 40px;">
        ...
        <el-form-item label="更新信息" prop="info">
          <el-input v-model="temp.info" placeholder="请输入更新信息"/>
        </el-form-item>
        <el-form-item label="更新内容" prop="content">
          <el-input v-model="temp.content" type="textarea" rows="3" placeholder="请输入更新内容"/>
        </el-form-item>
      </el-form>
...
<script>
import { fetchList, createLog, updateLog, deleteLog } from '@/api/updateLog'
